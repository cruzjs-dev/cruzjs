/**
 * Redis Rate Limit Adapter (Azure Cache for Redis)
 *
 ...
 *   EXEC
 *
 * For production, connect via REDIS_URL or AZURE_REDIS_URL environment variable.
 */
...
export class AzureRedisRateLimitAdapter implements RateLimitAdapter {
