/**
 * Redis Rate Limit Adapter (DigitalOcean Managed Redis)
 *
 * Uses DigitalOcean Managed Redis for distributed rate limiting.
...
export class DigitalOceanRedisRateLimitAdapter implements RateLimitAdapter {
