...
// The AI services ship as an Inversify container module. Load it into the DI
// container so AIProviderRegistry and friends are available for injection.
...
Visit `http://localhost:5000/chat`. Ask:
